...
var getTemplate = function(callback) {
	...
	console.log('SPARKPOST_API_KEY: %s', process.env.SPARKPOST_API_KEY);
	console.log('COGSF_TMPLT_ID: %s', process.env.COGSF_TMPLT_ID);
	console.log('COGSF_EMAIL_A: %s', process.env.COGSF_EMAIL_A);
	console.log('COGSF_NAME_A: %s', process.env.COGSF_NAME_A);
	console.log('COGSF_EMAIL_B: %s', process.env.COGSF_EMAIL_B);
	console.log('COGSF_NAME_B: %s', process.env.COGSF_NAME_B);
